`timescale 1ns/1ps
// Top-level Ethernet UDP loopback/ARP/ICMP wrapper for dual-port transparent design baseline.
// Ports implement a single RGMII interface connected through internal GMII logic.
module eth_udp_loop(
    input              sys_clk   , // 系统时钟
